...
if (alg == 0) {
  print("dalponte2016(chm, treetops, th_tree = 2, th_seed = 0.45, th_cr = 0.55, max_cr = 10, ID = 'treeID')")
...
if (alg == 1) {
  print("watershed(chm, th_tree = 2, tol = 1, ext = 1)")
...
if (alg == 2) {
  print("mcwatershed(chm, treetops, th_tree = 2, ID = 'treeID')")
...
if (alg == 3) {
  print("li2012(dt1 = 1.5, dt2 = 2, R = 2, Zu = 15, hmin = 2, speed_up = 10)")
...
if (alg == 4) {
  print("silva2016(chm, treetops, max_cr_factor = 0.6, exclusion = 0.3, ID = 'treeID')")
