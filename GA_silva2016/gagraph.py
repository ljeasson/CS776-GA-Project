...
def main(argv):
    ...
    plt.savefig("C:/Users/Lee/Desktop/CS776-GA-Project/GA_silva2016/figs/fitness.png")
    plt.draw()
    ...
    the_table.scale(2, 2)
    plt.savefig("C:/Users/Lee/Desktop/CS776-GA-Project/GA_silva2016/figs/rankings.png")
    plt.draw()
    plt.waitforbuttonpress(0)
    plt.close()
